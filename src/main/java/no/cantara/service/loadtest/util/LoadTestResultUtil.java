...
public class LoadTestResultUtil {
    ...
    public static final String STATS_R_MEAN_OVERHEAD_SUCCESS_MS = "stats_r_mean_overhead_success_ms";
    public static final String STATS_W_MEAN_OVERHEAD_SUCCESS_MS = "stats_w_mean_overhead_success_ms";
    ...
    public static SortedMap hasPassedBenchmark(List<LoadTestResult> loadTestResults, boolean whileRunning) {
        ...
        long r_overhead_duration_ms = 0;
        long w_duration_ms = 0;
        long w_overhead_duration_ms = 0;
        int r_results = 0;
        int w_deviations = 0;
        int w_success = 0;
        int w_results = 0;
        ...
        long r_mean_overhead_success_ms = 0;
        ...
        long w_mean_overhead_success_ms = 0;
        ...
        for (LoadTestResult loadTestResult : loadTestResults) {
            if (loadTestResult.getTest_id().startsWith("r-")) {
                ...
                if (loadTestResult.isTest_success()) {
                    ...
                    r_overhead_duration_ms += loadTestResult.getCommand_overhead();
                }
                ...
                if (loadTestResult.getTest_id().startsWith("w-")) {
                    ...
                    if (loadTestResult.isTest_success()) {
                        ...
                        w_overhead_duration_ms += loadTestResult.getCommand_overhead();
                    }
        ...
        if (r_success > 0) {
            ...
            r_mean_overhead_success_ms = r_overhead_duration_ms / r_success;
        ...
        if (w_success > 0) {
            ...
            w_mean_overhead_success_ms = w_overhead_duration_ms / w_success;
        ...
        statisticsMap.put(STATS_R_MEAN_OVERHEAD_SUCCESS_MS, Long.toString(r_mean_overhead_success_ms));
        ...
        statisticsMap.put(STATS_W_MEAN_OVERHEAD_SUCCESS_MS, Long.toString(w_mean_overhead_success_ms));
    ...
    public static String printStats(List<LoadTestResult> loadTestResults, boolean whileRunning) {
        ...
        if (statsMap.size() > 10) {
            ...
            stats = stats + "\n" + String.format(" %7d ms mean overhead duration successful read tests",
                    Integer.parseInt(statsMap.get(STATS_R_MEAN_OVERHEAD_SUCCESS_MS)));
            stats = stats + "\n" + String.format(" %7d ms mean overhead duration successful write tests",
                    Integer.parseInt(statsMap.get(STATS_W_MEAN_OVERHEAD_SUCCESS_MS)));
        }
        String loadTestJson = "";
