package no.cantara.service.proxy;
...
import static no.cantara.service.proxy.LoggingProxyResource.PROXY_PATH;

@Path(PROXY_PATH)
public class LoggingProxyResource {


    public static final String PROXY_PATH = "/proxy";

    private static final Logger log = LoggerFactory.getLogger(no.cantara.simulator.RestTestResource.class);

    @Autowired
    public LoggingProxyResource() {
    }
