...
public class CommandGetURLWithTemplate extends BaseHttpGetHystrixCommand<String> {
    ...
    public CommandGetURLWithTemplate(TestSpecification testSpecification) {
    ...
    public CommandGetURLWithTemplate(String uri, String contentType, String template, Map<String, String> templatereplacementMap) {
    ...
    public CommandGetURLWithTemplate(String uri, String contentType, String template, Map<String, String> templatereplacementMap, int timeout) {
